@extends('layouts.stisla.index', ['title' => 'Daftar Jenis', 'header' => 'Jenis'])
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" class="btn btn-danger text-white swal-delete" data-id="{{ $jen->id }}" title="Hapus data">
...
@push('modal')
@include('admin.jenis.modal.create')
@endpush