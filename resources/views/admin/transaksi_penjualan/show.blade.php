@extends('layouts.stisla.index', ['title' => 'Detail Transaksi Penjualan #' . $transaction->id, 'header' => 'Detail Transaki Penjualan #' . $transaction->id])
...
<div class="row">
    <div class=" col-12">
        <div class="card">
            <table class="table">
                <tr>
                    <td style="width: 200px;">Apoteker Kasir</td>
                ...
                <tr>
                    <td>Pembeli</td>
                    <td>:</td>
                    <td class="text-wrap">{{ $transaction->nama_pembeli }}</td>
                </tr>
                <tr>
    ...
    <div class="col-12 mt-4">
        <div class="card">
            ...
            <div class="modal-footer">
                <a href="{{ route('admin.penjualan.index') }}" class="btn btn-primary">Kembali</a>
            </div>
        </div>
    </div>
</div>
